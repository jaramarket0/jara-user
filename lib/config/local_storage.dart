...
// }
  ...
  saveSateAddress(String stateId) async {
    SharedPreferences sharedPreferences = await _pref;
    await sharedPreferences.setString('stateId', stateId);
    print('Address saved for State: $stateId');

    return true;
  }

    saveLGAAddress(String lga) async {
    SharedPreferences sharedPreferences = await _pref;
    await sharedPreferences.setString('lga', lga);
    print('Address saved for LGA: $lga');

    return true;
  }


    saveLGAAddressID(int lgaID) async {
    SharedPreferences sharedPreferences = await _pref;
    await sharedPreferences.setInt('lgaID', lgaID);
    print('Address saved for LGA ID: $lgaID');
...
// Get Cover Photo
  ...
  Future<String> getStateAddressId() async {
    SharedPreferences sharedPreferences = await _pref;

    if (sharedPreferences.containsKey('stateId')) {
      String data = sharedPreferences.getString('stateId')!;
      _stateId = data;
  ...
  Future<int> getLGAAddressId() async {
    SharedPreferences sharedPreferences = await _pref;

    if (sharedPreferences.containsKey('lgaID')) {
      int data = sharedPreferences.getInt('lgaID')!;
      _lgaId = data;
  ...
  Future<String> getLGAAddress() async {
    SharedPreferences sharedPreferences = await _pref;

    if (sharedPreferences.containsKey('lga')) {
      String data = sharedPreferences.getString('lga')!;
     // _lgaId = data;
